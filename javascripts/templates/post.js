...
templates['post'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<article>\n  <header>\n    <time datetime=\""
    ...
    + "\n    </h3>\n  </header>\n  <div class='content'>\n    ";
  stack1 = ((helper = (helper = helpers.strippedContent || (depth0 != null ? depth0.strippedContent : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"strippedContent","hash":{},"data":data}) : helper));
